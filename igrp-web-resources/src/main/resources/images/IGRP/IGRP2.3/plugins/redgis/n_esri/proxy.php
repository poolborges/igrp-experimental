<?php
   ...
   */
   ...
   //http://services.arcgisonline.com/ArcGIS/rest/services/  http://sampleserver1.arcgisonline.com/ArcGIS/rest/info?f=json
  //https://rai-gv-gis-02.gov.cv:6443/arcgis/rest/services/FeatureAcess/
  //http://tasks.arcgisonline.com/
  //http://rai-tst-osg-01.gov.cv
//http://services.arcgisonline.com/ArcGIS/rest/services/World_Street_Map/MapServer<
//https://nosiappsdev.gov.cv

  $serverUrls = array(
	array( 'url' => 'https://rai-gv-gis-02.gov.cv:6443/',                     'matchAll' => true, 'token' => '' ),

  array( 'url' => 'http://arcgis.gov.cv',                     'matchAll' => true, 'token' => '' ),

  array( 'url' => 'http://sampleserver1.arcgisonline.com/ArcGIS/',          'matchAll' => true, 'token' => '' ),
  array( 'url' => 'http://idecv1.sit.gov.cv',                               'matchAll' => true, 'token' => '' ),
  array( 'url' => 'https://nosigis.gov.cv/',                                'matchAll' => true, 'token' => '' ),
  array( 'url' => '//rai-gv-gis-02.gov.cv:6080/',      		                  'matchAll' => true, 'token' => '' ),
	array( 'url' => 'https://services.arcgisonline.com/ArcGIS/rest/services/',      'matchAll' => true, 'token' => '' ),
  array( 'url' => 'http://services.arcgisonline.com/ArcGIS/rest/services/',      'matchAll' => true, 'token' => '' ),
  array( 'url' => '//services.arcgisonline.com/ArcGIS/rest/services/',      'matchAll' => true, 'token' => '' ),
	array( 'url' => 'https://www.arcgis.com/',      								                'matchAll' => true, 'token' => '' ),
  array( 'url' => '//www.arcgis.com/',                                      'matchAll' => true, 'token' => '' ),
	array( 'url' => 'https://nosiappsdev.gov.cv',                            'matchAll' => true, 'token' => '' ),
  array( 'url' => '//nosiappsdev.gov.cv',                            'matchAll' => true, 'token' => '' ),
  array( 'url' => 'http://igrp.teste.gov.cv/',                              'matchAll' => true, 'token' => '' ),
  array( 'url' => 'http://rai-tst-osg-01.gov.cv:8080/',                     'matchAll' => true, 'token' => '' ),
	array( 'url' =>	'//tasks.arcgisonline.com/ArcGIS/rest/services/',		   		'matchAll' => true, 'token' => '' ),
	array( 'url' => 'http://tasks.arcgisonline.com/ArcGIS/rest/services/Geometry/GeometryServer/union',         'matchAll' => true, 'token' => '' ),
  array( 'url' => 'https://tasks.arcgisonline.com/',         'matchAll' => true, 'token' => '' ),
  array( 'url' => 'http://tasks.arcgisonline.com/',         'matchAll' => true, 'token' => '' ),
  array( 'url' => 'https://rai-gv-gis-02.gov.cv:6443/arcgis/rest/services', 'matchAll' => true, 'token' => '' ),
  array( 'url' =>	'//rai-gv-gis-02.gov.cv:6443/arcgis/rest/',	   		        'matchAll' => true, 'token' => '' )
  );
  /***************************************************************************/

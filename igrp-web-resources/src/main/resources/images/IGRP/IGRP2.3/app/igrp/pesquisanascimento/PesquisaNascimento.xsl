<xsl:stylesheet
                                                    ...
                                                    <div class="box igrp-forms gen-container-item " gen-class="" item-name="form_1">
                                                        <div class="box-body">
                                                            <div role="form">
                                                                ...
                                                                <xsl:if test="rows/content/form_1/fields/n_registo">
                                                                    <div class="form-group col-sm-3   gen-fields-holder" item-name="n_registo" item-type="text">
                                                                        <label for="{rows/content/form_1/fields/n_registo/@name}">
                                                                            <span>
                                                                                <xsl:value-of select="rows/content/form_1/fields/n_registo/label"/>
                                                                            </span>
                                                                        </label>
                                                                        <input type="text" value="{rows/content/form_1/fields/n_registo/value}" class="form-control " id="{rows/content/form_1/fields/n_registo/@name}" name="{rows/content/form_1/fields/n_registo/@name}" maxlength="30" placeholder="">
                                                                            <xsl:call-template name="setAttributes">
                                                                                <xsl:with-param name="field" select="rows/content/form_1/fields/n_registo"/>
                                                                            </xsl:call-template>
                                                                        </input>
                                                                    </div>
                                                                </xsl:if>
                                                    ...
                                                    <div class="box box-table-contents gen-container-item " gen-class="" item-name="table_1">
                                                        <div class="box-body table-box">
                                                            ...
                                                            <table id="table_1" class="table table-striped gen-data-table  " exports="">
                                                                <thead>
                                                                    <tr>
                                                                        <xsl:if test="rows/content/table_1/fields/n_registo_tabela">
                                                                            <th align="left" class=" gen-fields-holder">
                                                                                <span>
                                                                                    <xsl:value-of select="rows/content/table_1/fields/n_registo_tabela/label"/>
                                                                                </span>
                                                                            </th>
                                                                        </xsl:if>
                                                                        ...
                                                                        <xsl:if test="rows/content/table_1/fields/data_facto">
                                                                            <th align="left" class=" gen-fields-holder">
                                                                                <span>
                                                                                    <xsl:value-of select="rows/content/table_1/fields/data_facto/label"/>
                                                                                </span>
                                                                            </th>
                                                                        </xsl:if>
                                                                ...
                                                                <tbody>
                                                                    <xsl:for-each select="rows/content/table_1/table/value/row[not(@total='yes')]">
                                                                        <tr>
                                                                            ...
                                                                            <xsl:if test="n_registo_tabela">
                                                                                <td align="left" data-row="{position()}" data-title="{../../fields/n_registo_tabela/label}" class="text" item-name="n_registo_tabela">
                                                                                    <span class="lookup-parser">
                                                                                        <xsl:value-of select="n_registo_tabela"/>
                                                                                    </span>
                                                                                </td>
                                                                            </xsl:if>
                                                                            ...
                                                                            <xsl:if test="data_facto">
                                                                                <td align="left" data-row="{position()}" data-title="{../../fields/data_facto/label}" class="text" item-name="data_facto">
                                                                                    <span class="">
                                                                                        <xsl:value-of select="data_facto"/>
                                                                                    </span>
                                                                                </td>
                                                                            </xsl:if>
    ...
    <xsl:include href="../../../xsl/tmpl/IGRP-functions.tmpl.xsl?v=1510839130314"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-variables.tmpl.xsl?v=1510839130314"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=1510839130314"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-utils.tmpl.xsl?v=1510839130314"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-form-utils.tmpl.xsl?v=1510839130314"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-table-utils.tmpl.xsl?v=1510839130315"/>
</xsl:stylesheet>

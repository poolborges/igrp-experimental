<xsl:stylesheet
                                                        ...
                                                        <div class="box-body">
                                                            <div role="form">
                                                                ...
                                                                <xsl:if test="rows/content/form_1/fields/bi">
                                                                    <div class="form-group col-sm-3   gen-fields-holder" item-name="bi" item-type="number">
                                                                        <label for="{rows/content/form_1/fields/bi/@name}">
                                                                            <span>
                                                                                <xsl:value-of select="rows/content/form_1/fields/bi/label"/>
                                                                            </span>
                                                                        </label>
                                                                        <input type="number" value="{rows/content/form_1/fields/bi/value}" class="form-control " id="{rows/content/form_1/fields/bi/@name}" name="{rows/content/form_1/fields/bi/@name}" min="" max="" maxlength="30" placeholder="">
                                                                            <xsl:call-template name="setAttributes">
                                                                                <xsl:with-param name="field" select="rows/content/form_1/fields/bi"/>
                                                                            </xsl:call-template>
                                                                        </input>
                                                                    </div>
                                                                </xsl:if>
                                                    ...
                                                    <div class="box box-table-contents gen-container-item " gen-class="" item-name="table_1">
                                                        <div class="box-body table-box">
                                                            ...
                                                            <table id="table_1" class="table table-striped gen-data-table  " exports="">
                                                                <thead>
                                                                    <tr>
                                                                        <xsl:if test="rows/content/table_1/fields/bi_tabela">
                                                                            <th align="left" class=" gen-fields-holder">
                                                                                <span>
                                                                                    <xsl:value-of select="rows/content/table_1/fields/bi_tabela/label"/>
                                                                                </span>
                                                                            </th>
                                                                        </xsl:if>
                                                                ...
                                                                <tbody>
                                                                    <xsl:for-each select="rows/content/table_1/table/value/row[not(@total='yes')]">
                                                                        <tr>
                                                                            ...
                                                                            <xsl:if test="bi_tabela">
                                                                                <td align="left" data-row="{position()}" data-title="{../../fields/bi_tabela/label}" class="text" item-name="bi_tabela">
                                                                                    <span class="lookup-parser">
                                                                                        <xsl:value-of select="bi_tabela"/>
                                                                                    </span>
                                                                                </td>
                                                                            </xsl:if>
    ...
    <xsl:include href="../../../xsl/tmpl/IGRP-functions.tmpl.xsl?v=1510826999475"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-variables.tmpl.xsl?v=1510826999475"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=1510826999475"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-utils.tmpl.xsl?v=1510826999475"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-form-utils.tmpl.xsl?v=1510826999476"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-table-utils.tmpl.xsl?v=1510826999476"/>
</xsl:stylesheet>

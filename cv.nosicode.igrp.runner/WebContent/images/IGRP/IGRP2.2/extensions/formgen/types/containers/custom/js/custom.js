var GENCUSTOM = function(name,params){
	...
	var isXMLSet = params && params.proprieties.XML ? true : false;
	var isXSLSet = params && params.proprieties.XSL ? true : false;
	...
	container.getXSL = function(){
		return $.parseXML(container.replaceContainersGenVars(setXmlnsAttr(container.template)));
	}

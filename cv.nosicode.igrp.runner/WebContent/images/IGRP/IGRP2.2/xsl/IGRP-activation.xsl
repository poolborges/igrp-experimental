...
<header id="myCarousel" class="carousel slide">
  ...
  <xsl:variable name="version">
  	<xsl:choose>
    	<xsl:when test="$banner/version"><xsl:value-of select="$banner/version"/></xsl:when>
    ...
    <form action="{rows/content/action}" method="post" id="formular_log" class="login_formular">
        ...
        <div class="loginarea active">
            <div class="filds">
                ...
                <div class="fild">
                    <div class="img user"/>
                    <input type="text" name="{rows/content/form/value/user/@name}" value="{rows/content/form/value/user}" placeholder="{rows/content/form/label/user}"/>
                </div>
                <div class="fild">
                    <div class="img pass"/>
                    <input type="password" name="{rows/content/form/value/password/@name}" placeholder="{rows/content/form/label/password}" autocomplete="off"/>
                </div>
                <div class="fild">
                    <div class="img chave"/>
                    <input type="password" name="{rows/content/form/value/key/@name}" placeholder="{rows/content/form/label/key}" autocomplete="off"/>
            ...
            <div class="filds">
                ...
                <div class="fild submit">
                    <input type="button" id="activartoken" name="{rows/content/form/value/buttontoken/@name}" class="submit" value="{rows/content/form/label/buttontoken}"/>
                </div>
                <div class="_clear"/>
            </div>
        </div>

                ...
                <form class="IGRP-form" name="formular_default">
                    ...
                    <form-hidden class="form-hidden" style="display:none!important">
                        ...
                        <xsl:if test="rows/content/form/label/id_objeto">
                            <input type="hidden" id="id_objeto" name="{rows/content/form/value/id_objeto/@name}" value="{rows/content/form/value/id_objeto}" class="number form-hidden" maxlength="100"/>
                        </xsl:if>
                                ...
                                <div class="modal-body" role="form">
                                    <div id="gen-page-settings" rel="settings">
                                        ...
                                        <div class="col-md-6 form-group" item-name="table_name">
                                            ...
                                            <input rel="table" type="text" name="plsql_table" value="" class="text gen-page-setter form-control" maxlength="100"/>
                                        </div>
                                        <div class="col-md-6 form-group" item-name="package_db_name" required="required">
                                            <label>Package Name (DB)</label>
                                            <input rel="package" required="" type="text" name="plsql_pack" value="" class="text gen-page-setter form-control" maxlength="100"/>
                                        </div>
                                        <div class="col-md-6 form-group" item-name="package_html_name" required="required">
                                            <label>Package Name (HTML)</label>
                                            <input rel="html" type="text" required="" name="plsql_html" value="" class="text gen-page-setter form-control" maxlength="100"/>
                                        </div>

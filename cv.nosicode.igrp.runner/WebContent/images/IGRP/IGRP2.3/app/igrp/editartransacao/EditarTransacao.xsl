<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
                              ...
                              <div role="form">
                                ...
                                <xsl:if test="rows/content/form_1/fields/codigo">
                                  <div class="form-group col-md-3   gen-fields-holder" item-name="codigo" item-type="text" required="required">
                                    ...
                                    <input type="text" value="{rows/content/form_1/fields/codigo/value}" class="form-control " id="{rows/content/form_1/fields/codigo/@name}" name="{rows/content/form_1/fields/codigo/@name}" required="required" maxlength="100" placeholder="">
                                    </input>
                                  </div>
                                </xsl:if>
                                <xsl:if test="rows/content/form_1/fields/descricao">
                                  <div class="form-group col-md-3   gen-fields-holder" item-name="descricao" item-type="text" required="required">
                                    ...
                                    <input type="text" value="{rows/content/form_1/fields/descricao/value}" class="form-control " id="{rows/content/form_1/fields/descricao/@name}" name="{rows/content/form_1/fields/descricao/@name}" required="required" maxlength="150" placeholder="">
                                    </input>
                                  </div>
                                </xsl:if>
  ...
  <xsl:include href="../../../xsl/tmpl/IGRP-functions.tmpl.xsl?v=1495127309556"/>
  <xsl:include href="../../../xsl/tmpl/IGRP-variables.tmpl.xsl?v=1495127309556"/>
  <xsl:include href="../../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=1495127309556"/>
  <xsl:include href="../../../xsl/tmpl/IGRP-utils.tmpl.xsl?v=1495127309556"/>
  <xsl:include href="../../../xsl/tmpl/IGRP-form-utils.tmpl.xsl?v=1495127309556"/>
</xsl:stylesheet>

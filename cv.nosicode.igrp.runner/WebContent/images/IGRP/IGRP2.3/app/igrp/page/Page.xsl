<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
                            ...
                            <div class="box-body">
                              <div role="form">
                                ...
                                <xsl:if test="rows/content/form_1/fields/env_fk">
                                  <div class="col-md-4 form-group  gen-fields-holder" item-name="env_fk" item-type="select" required="required">
                                ...
                                <xsl:if test="rows/content/form_1/fields/version">
                                  <div class="col-md-4 form-group  gen-fields-holder" item-name="version" item-type="select" required="required">
                                ...
                                <xsl:if test="rows/content/form_1/fields/page">
                                  <div class="form-group col-md-4   gen-fields-holder" item-name="page" item-type="text" required="required">
                                ...
                                <xsl:if test="rows/content/form_1/fields/action_descr">
                                  <div class="form-group col-md-12  gen-fields-holder" item-name="action_descr" item-type="textarea">
                                    <label for="{rows/content/form_1/fields/action_descr/@name}">
                                      <xsl:value-of select="rows/content/form_1/fields/action_descr/label"/>
                                    </label>
                                    <textarea name="{rows/content/form_1/fields/action_descr/@name}" class="textarea form-control " maxlength="100">
                                      <xsl:value-of select="rows/content/form_1/fields/action_descr/value"/>
                                    </textarea>
                                  </div>
                                </xsl:if>
                              </div>
  ...
  <xsl:include href="../../../xsl/tmpl/IGRP-functions.tmpl.xsl?v=1494594559406"/>
  <xsl:include href="../../../xsl/tmpl/IGRP-variables.tmpl.xsl?v=1494594559406"/>
  <xsl:include href="../../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=1494594559406"/>
  <xsl:include href="../../../xsl/tmpl/IGRP-utils.tmpl.xsl?v=1494594559406"/>
  <xsl:include href="../../../xsl/tmpl/IGRP-form-utils.tmpl.xsl?v=1494594559406"/>
</xsl:stylesheet>

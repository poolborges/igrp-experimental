<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
                          ...
                          <div class="box igrp-forms gen-container-item " gen-class="" item-name="form_1">
                            <div class="box-body">
                              <div role="form">
                                ...
                                <xsl:if test="rows/content/form_1/fields/organia">
                                  <div class="col-md-3 form-group  gen-fields-holder" item-name="organia" item-type="select">
                                    <label for="{rows/content/form_1/fields/organia/@name}">
                                      <xsl:value-of select="rows/content/form_1/fields/organia/label"/>
                                    </label>
                                    <select class="form-control select2 " id="form_1_organia" name="{rows/content/form_1/fields/organia/@name}">
                                      <xsl:for-each select="rows/content/form_1/fields/organia/list/option">
                                        <option value="{value}" label="{text}">
                                          <xsl:if test="@selected='true'">
                                            <xsl:attribute name="selected">selected
                                            </xsl:attribute>
  ...
  <xsl:include href="../../../xsl/tmpl/IGRP-functions.tmpl.xsl?v=1494312857277"/>
  <xsl:include href="../../../xsl/tmpl/IGRP-variables.tmpl.xsl?v=1494312857277"/>
  <xsl:include href="../../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=1494312857277"/>
  <xsl:include href="../../../xsl/tmpl/IGRP-utils.tmpl.xsl?v=1494312857277"/>
  <xsl:include href="../../../xsl/tmpl/IGRP-form-utils.tmpl.xsl?v=1494312857277"/>
  <xsl:include href="../../../xsl/tmpl/IGRP-table-utils.tmpl.xsl?v=1494312857277"/>
</xsl:stylesheet>

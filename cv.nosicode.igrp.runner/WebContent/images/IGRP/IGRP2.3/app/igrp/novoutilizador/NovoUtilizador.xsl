<xsl:stylesheet
                                                        ...
                                                        <div class="box-body">
                                                            <div role="form">
                                                                ...
                                                                <xsl:if test="rows/content/form_1/fields/email">
                                                                    <div class="form-group col-md-3   gen-fields-holder" item-name="email" item-type="email" required="required">
                                                                        <label for="{rows/content/form_1/fields/email/@name}">
                                                                            <span>
                                                                                <xsl:value-of select="rows/content/form_1/fields/email/label"/>
                                                                            </span>
                                                                        </label>
                                                                        <input type="email" value="{rows/content/form_1/fields/email/value}" class="form-control " id="{rows/content/form_1/fields/email/@name}" name="{rows/content/form_1/fields/email/@name}" required="required" maxlength="100" placeholder=""></input>
                                                                    </div>
                                                                </xsl:if>
                                                                ...
                                                                <xsl:if test="rows/content/form_1/fields/perfil">
                                                                    <div class="col-md-3 form-group  gen-fields-holder" item-name="perfil" item-type="select" required="required">
                                                                        <label for="{rows/content/form_1/fields/perfil/@name}">
                                                                            <xsl:value-of select="rows/content/form_1/fields/perfil/label"/>
                                                                        </label>
                                                                        <select class="form-control select2 " id="form_1_perfil" name="{rows/content/form_1/fields/perfil/@name}" required="required">
                                                                ...
                                                                <xsl:if test="rows/content/form_1/fields/portal">
                                                                    <div class="col-md-3  gen-fields-holder" item-name="portal" item-type="checkbox">
                                                                        <div class="form-group">
                                                                            <div class="checkbox form-check-offset">
                                                                                <label>
                                                                                    <input type="checkbox" name="{rows/content/form_1/fields/portal/@name}" value="1" class="checkbox " label="{rows/content/form_1/fields/portal/label}">
                                                                                        <xsl:if test="rows/content/form_1/fields/portal/value = '1'">
                                                                                            <xsl:attribute name="checked">checked</xsl:attribute>
                                                                                        </xsl:if>
                                                                                    </input>
                                                                                    <span>
                                                                                        <xsl:value-of select="rows/content/form_1/fields/portal/label"/>
                                                                                    </span>
                                                                                </label>
                                                                            </div>
                                                                        </div>
    ...
    <xsl:include href="../../../xsl/tmpl/IGRP-functions.tmpl.xsl?v=1493300705924"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-variables.tmpl.xsl?v=1493300705924"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=1493300705924"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-utils.tmpl.xsl?v=1493300705924"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-form-utils.tmpl.xsl?v=1493300705924"/>
</xsl:stylesheet>

<xsl:stylesheet
                                                                ...
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <xsl:if test="rows/content/table_1/fields/ativo">
                                                                            <th align="left" class=" gen-fields-holder">
                                                                                <span>
                                                                                    <xsl:value-of select="rows/content/table_1/fields/ativo/label"/>
                                                                                </span>
                                                                            </th>
                                                                        </xsl:if>
                                                                        <xsl:if test="rows/content/table_1/fields/checkbox">
                                                                            <th class="bs-checkbox gen-fields-holder" align="center">
                                                                                <input type="checkbox" class="IGRP_checkall" check-rel="checkbox"/>
                                                                            </th>
                                                                        </xsl:if>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                                    <xsl:for-each select="rows/content/table_1/table/value/row">
                                                                        <tr>
                                                                            ...
                                                                            <xsl:if test="titulo">
                                                                                <td align="left" data-row="{position()}" data-title="{../../fields/titulo/label}" class="plaintext">
                                                                                    <span class="">
                                                                            ...
                                                                            <xsl:if test="pagina">
                                                                                <td align="left" data-row="{position()}" data-title="{../../fields/pagina/label}" class="plaintext">
                                                                                    <span class="">
                                                                            ...
                                                                            <xsl:if test="ativo">
                                                                                <td align="left" data-row="{position()}" data-title="{../../fields/ativo/label}" class="plaintext">
                                                                                    <span class="">
                                                                            ...
                                                                            <xsl:if test="checkbox">
                                                                                <td align="" data-row="{position()}" data-title="{../../label/checkbox}" class="bs-checkbox">
    ...
    <xsl:include href="../../../xsl/tmpl/IGRP-functions.tmpl.xsl?v=1493989020989"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-variables.tmpl.xsl?v=1493989020989"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=1493989020989"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-utils.tmpl.xsl?v=1493989020989"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-form-utils.tmpl.xsl?v=1493989020990"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-table-utils.tmpl.xsl?v=1493989020990"/>
</xsl:stylesheet>

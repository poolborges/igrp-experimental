<xsl:stylesheet
                                                        ...
                                                        <div class="box-body">
                                                            <div role="form">
                                                                ...
                                                                <xsl:if test="rows/content/form_1/fields/data_nascimento">
                                                                    <div class="form-group col-sm-3  gen-fields-holder" item-name="data_nascimento" item-type="date" required="required">
                                                                ...
                                                                <xsl:if test="rows/content/form_1/fields/sexo">
                                                                    <div class="col-sm-3 form-group  gen-fields-holder" item-name="sexo" item-type="select" required="required">
    ...
    <xsl:include href="../../../xsl/tmpl/IGRP-functions.tmpl.xsl?v=1502888297264"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-variables.tmpl.xsl?v=1502888297264"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=1502888297264"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-utils.tmpl.xsl?v=1502888297264"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-form-utils.tmpl.xsl?v=1502888297264"/>
</xsl:stylesheet>

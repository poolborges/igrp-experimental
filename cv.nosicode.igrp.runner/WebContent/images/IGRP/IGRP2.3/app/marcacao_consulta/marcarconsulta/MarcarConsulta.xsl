                                                        ...
                                                        <div class="box-body">
                                                            <div role="form">
                                                                ...
                                                                <xsl:if test="rows/content/form_1/fields/utente">
                                                                    <div class="col-sm-4 form-group  gen-fields-holder" item-name="utente" item-type="select" required="required">
                                                                ...
                                                                <xsl:if test="rows/content/form_1/fields/medico">
                                                                    <div class="col-sm-4 form-group  gen-fields-holder" item-name="medico" item-type="select" required="required">
                                                                ...
                                                                <xsl:if test="rows/content/form_1/fields/data_consulta">
                                                                    <div class="form-group col-sm-3  gen-fields-holder" item-name="data_consulta" item-type="date" required="required">

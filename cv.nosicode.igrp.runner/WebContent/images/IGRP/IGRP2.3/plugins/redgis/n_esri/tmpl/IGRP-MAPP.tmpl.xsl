<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template name="igrp-mapp" mode="igrp-mapp" match="map">
    ...
    <xsl:choose>
      <xsl:when test=". and . != ''">
        ...
        <includes>
        <link href="{$path}/extentions/n_esri/css/esri.css" rel="stylesheet"/>
        <link rel="stylesheet" href="//js.arcgis.com/3.10/js/dojo/dijit/themes/claro/claro.css"/>
        <link href="//code.jquery.com/ui/1.10.4/themes/smoothness/jquery-ui.css" rel="stylesheet"/>
        <link href="{$path}/extentions/n_esri/css/redgisapp.css" rel="stylesheet"/>
        <link href="{$path}/extentions/n_esri/widgets/css/widgets.css" rel="stylesheet"/>
        <link href="{$path}/extentions/n_esri/widgets/css/steps.config.css" rel="stylesheet"/>
        <link href="{$path}/extentions/n_esri/css/{$color}.css" rel="stylesheet"/>
        <script src="{$path}/extentions/n_esri/js/jquery-1.9.1.min.js"></script> 
        <script>
       	  jQ = $.noConflict();
          var path = '<xsl:value-of select="$path"/>';
        </script> 
        <script src="{$path}/extentions/n_esri/js/jquery-ui.js"></script> 
        <script src="{$path}/extentions/n_esri/js/esri.3.13.js"></script>     
        <!-- <script src="{$path}/extentions/n_esri/js/esri.js"></script>   -->     
        <script src="{$path}/extentions/n_esri/js/dojo.require.js"></script> 
        <script src="{$path}/extentions/n_esri/js/mapp.library.js"></script> 
        <script src="{$path}/extentions/n_esri/js/mapp.js"></script> 
        <script src="{$path}/extentions/n_esri/js/Widgets.js"></script> 
        <script src="{$path}/extentions/n_esri/js/LayersManager.js"></script> 
        <script src="{$path}/extentions/n_esri/js/Geometry.js"></script> 
        <script src="{$path}/extentions/n_esri/js/nosi.jquery.xmlXslt.js"></script>
        <script src="{$path}/extentions/n_esri/js/xml.xsl.transform.js"></script> 
        </includes>
        <img src="{$path}/extentions/n_esri/img/loading.gif" id="loading"/>
        <div id="mapp-holder">
      ...
      <xsl:otherwise>
        <xsl:text>Erro ao carregar mapa.</xsl:text>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>
</xsl:stylesheet>
(function ( jQ ) { 
    jQ.fn.timeSlider = function(params) {
        ...
        "dojo/_base/array", "dojo/dom", "dojo/domReady!"
			...
			ts.getDateStartDate = function(startDate){
				var smonth = startDate.getUTCMonth() + 1 ; //months from 1-12
				var sday = startDate.getUTCDate();
				var syear = startDate.getUTCFullYear();

				sdate = sday + '-'+ smonth +'-'+ syear;
			}

			ts.getDateEndDate = function(endDate){
				var emonth = endDate.getUTCMonth() + 1; //months from 1-12
				var eday = endDate.getUTCDate();
				var eyear = endDate.getUTCFullYear();				

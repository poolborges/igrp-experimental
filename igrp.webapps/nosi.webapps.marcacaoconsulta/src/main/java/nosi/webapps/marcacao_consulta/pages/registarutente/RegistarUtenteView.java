...
public class RegistarUtenteView extends View {
    ...
    public RegistarUtenteView(RegistarUtente model) {
        this.setPageTitle("Registar Utente");
        ...
        sexo.setLabel("Sexo");
        sexo.propertie().add("name", "p_sexo").add("type", "select").add("multiple", "false").add("maxlength", "30").add("required", "true").add("change", "false").add("disabled", "false").add("right", "false").add("domain", "");

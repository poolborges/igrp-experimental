<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
                            ...
                            <div class="box-body">
                              <div role="form">
                                ...
                                <xsl:if test="rows/content/form_1/fields/balcao">
                                  <div class="col-sm-3 form-group  gen-fields-holder" item-name="balcao" item-type="select" required="required">
                                ...
                                <xsl:if test="rows/content/form_1/fields/servico">
                                  <div class="col-sm-3 form-group  gen-fields-holder" item-name="servico" item-type="select">
  ...
  <xsl:include href="../../../xsl/tmpl/IGRP-functions.tmpl.xsl?v=1502452303463"/>
  <xsl:include href="../../../xsl/tmpl/IGRP-variables.tmpl.xsl?v=1502452303463"/>
  <xsl:include href="../../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=1502452303463"/>
  <xsl:include href="../../../xsl/tmpl/IGRP-utils.tmpl.xsl?v=1502452303463"/>
  <xsl:include href="../../../xsl/tmpl/IGRP-form-utils.tmpl.xsl?v=1502452303464"/>
  <xsl:include href="../../../xsl/tmpl/IGRP-table-utils.tmpl.xsl?v=1502452303464"/>
</xsl:stylesheet>

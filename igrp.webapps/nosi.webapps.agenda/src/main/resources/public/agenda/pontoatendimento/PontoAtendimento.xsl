<xsl:stylesheet
                                                        ...
                                                        <div class="box-body">
                                                            <div role="form">
                                                                ...
                                                                <xsl:if test="rows/content/form_1/fields/entidade">
                                                                    <div class="col-sm-12 form-group  gen-fields-holder" item-name="entidade" item-type="select">
                                                                        <label for="{rows/content/form_1/fields/entidade/@name}">
                                                                            <xsl:value-of select="rows/content/form_1/fields/entidade/label"/>
                                                                        </label>
                                                                        <select class="form-control select2 IGRP_change" id="form_1_entidade" name="{rows/content/form_1/fields/entidade/@name}">
                                                    ...
                                                    <div class="box igrp-forms gen-container-item " gen-class="" item-name="form_2">
                                                        <div class="box-body">
                                                            <div role="form">
                                                                ...
                                                                <xsl:if test="rows/content/form_2/fields/ponto">
                                                                    <div class="form-group col-sm-4   gen-fields-holder" item-name="ponto" item-type="text" required="required">
                                                                        <label for="{rows/content/form_2/fields/ponto/@name}">
                                                                            <span>
                                                                                <xsl:value-of select="rows/content/form_2/fields/ponto/label"/>
                                                                            </span>
                                                                        </label>
                                                                        <input type="text" value="{rows/content/form_2/fields/ponto/value}" class="form-control " id="{rows/content/form_2/fields/ponto/@name}" name="{rows/content/form_2/fields/ponto/@name}" required="required" maxlength="30" placeholder="">
                                                                            <xsl:call-template name="setAttributes">
                                                                                <xsl:with-param name="field" select="rows/content/form_2/fields/ponto"/>
                                                                            </xsl:call-template>
                                                                        </input>
                                                                    </div>
                                                                </xsl:if>
                                                                <xsl:if test="rows/content/form_2/fields/n_de_servicos">
                                                                    <div class="col-sm-4 form-group  gen-fields-holder" item-name="n_de_servicos" item-type="select" required="required">
                                                                        <label for="{rows/content/form_2/fields/n_de_servicos/@name}">
                                                                            <xsl:value-of select="rows/content/form_2/fields/n_de_servicos/label"/>
                                                                        </label>
                                                                        <select class="form-control select2 " id="form_2_n_de_servicos" name="{rows/content/form_2/fields/n_de_servicos/@name}" required="required">
                                                                            <xsl:call-template name="setAttributes">
                                                                                <xsl:with-param name="field" select="rows/content/form_2/fields/n_de_servicos"/>
                                                                            </xsl:call-template>
                                                                            <xsl:for-each select="rows/content/form_2/fields/n_de_servicos/list/option">
                                                                                <option value="{value}" label="{text}">
                                                                                    <xsl:if test="@selected='true'">
                                                                                        <xsl:attribute name="selected">selected</xsl:attribute>
                                                                                    </xsl:if>
                                                                ...
                                                                <xsl:if test="rows/content/form_2/fields/localizacao">
                                                                    <div class="form-group col-sm-4   gen-fields-holder" item-name="localizacao" item-type="text" required="required">
                                                                        <label for="{rows/content/form_2/fields/localizacao/@name}">
                                                                            <span>
                                                                                <xsl:value-of select="rows/content/form_2/fields/localizacao/label"/>
                                                                            </span>
                                                                        </label>
                                                                        <input type="text" value="{rows/content/form_2/fields/localizacao/value}" class="form-control " id="{rows/content/form_2/fields/localizacao/@name}" name="{rows/content/form_2/fields/localizacao/@name}" required="required" maxlength="30" placeholder="">
                                                                            <xsl:call-template name="setAttributes">
                                                                                <xsl:with-param name="field" select="rows/content/form_2/fields/localizacao"/>
                                                                            </xsl:call-template>
                                                                        </input>
                                                                    </div>
                                                                </xsl:if>
                                                                <xsl:if test="rows/content/form_2/fields/fuso_horario">
                                                                    <div class="form-group col-sm-4   gen-fields-holder" item-name="fuso_horario" item-type="text" required="required">
                                                                        <label for="{rows/content/form_2/fields/fuso_horario/@name}">
                                                                            <span>
                                                                                <xsl:value-of select="rows/content/form_2/fields/fuso_horario/label"/>
                                                                            </span>
                                                                        </label>
                                                                        <input type="text" value="{rows/content/form_2/fields/fuso_horario/value}" class="form-control " id="{rows/content/form_2/fields/fuso_horario/@name}" name="{rows/content/form_2/fields/fuso_horario/@name}" required="required" maxlength="300" placeholder="">
                                                                            <xsl:call-template name="setAttributes">
                                                                                <xsl:with-param name="field" select="rows/content/form_2/fields/fuso_horario"/>
                                                                            </xsl:call-template>
                                                                        </input>
                                                                    </div>
                                                                </xsl:if>
                                                                <xsl:if test="rows/content/form_2/fields/confirmacao_automatica">
                                                                    <div class="col-sm-4  gen-fields-holder" item-name="confirmacao_automatica" item-type="radiolist" required="required">
                                                                        <div class="form-group radiolist clear" required="required">
                                                                            <label>
                                                                                <span>
                                                                                    <xsl:value-of select="rows/content/form_2/fields/confirmacao_automatica/label"/>
                                                                                </span>
                                                                            </label>
                                                                            <xsl:for-each select="rows/content/form_2/fields/confirmacao_automatica/list/option">
                                                                                <div class="radio col-md-12">
                                                                                    <label>
                                                                                        <input required="required" type="radio" name="{../../@name}" value="{value}" class="radiolist " label="{text}">
                                                                                            <xsl:call-template name="setAttributes">
                                                                                                <xsl:with-param name="field" select="//rows/content/form_2/fields/confirmacao_automatica"/>
                                                                                            </xsl:call-template>
                                                                                            <xsl:if test="@selected='true'">
                                                                ...
                                                                <xsl:if test="rows/content/form_2/fields/horario_de_atendimento">
                                                                    <div class="box-head subtitle gen-fields-holder" text-color="1">
                                                                        <span>
                                                                            <xsl:value-of select="rows/content/form_2/fields/horario_de_atendimento/label"/>
                                                                        </span>
                                                                    </div>
                                                                </xsl:if>
                                                                <xsl:if test="rows/content/form_2/fields/hora_inicio">
                                                                    <div class="form-group col-sm-4  gen-fields-holder" item-name="hora_inicio" item-type="date" required="required">
                                                                        <label for="{rows/content/form_2/fields/hora_inicio/@name}">
                                                                            <span>
                                                                                <xsl:value-of select="rows/content/form_2/fields/hora_inicio/label"/>
                                                                            </span>
                                                                        </label>
                                                                        <div class="input-group">
                                                                            <input type="text" value="{rows/content/form_2/fields/hora_inicio/value}" class="form-control gen-date " id="form_2-hora_inicio" name="{rows/content/form_2/fields/hora_inicio/@name}" required="required" format="IGRP_timePicker" maxlength="30">
                                                                                <xsl:call-template name="setAttributes">
                                                                                    <xsl:with-param name="field" select="rows/content/form_2/fields/hora_inicio"/>
                                                                                </xsl:call-template>
                                                                            </input>
                                                                ...
                                                                <xsl:if test="rows/content/form_2/fields/hora_fim">
                                                                    <div class="form-group col-sm-4  gen-fields-holder" item-name="hora_fim" item-type="date" required="required">
                                                                        <label for="{rows/content/form_2/fields/hora_fim/@name}">
                                                                            <span>
                                                                                <xsl:value-of select="rows/content/form_2/fields/hora_fim/label"/>
                                                                            </span>
                                                                        </label>
                                                                        <div class="input-group">
                                                                            <input type="text" value="{rows/content/form_2/fields/hora_fim/value}" class="form-control gen-date " id="form_2-hora_fim" name="{rows/content/form_2/fields/hora_fim/@name}" required="required" format="IGRP_timePicker" maxlength="30">
                                                                                <xsl:call-template name="setAttributes">
                                                                                    <xsl:with-param name="field" select="rows/content/form_2/fields/hora_fim"/>
                                                                                </xsl:call-template>
                                                                            </input>
                                                                            <span class="input-group-btn gen-date-icon">
                                                                                <span class="btn btn-default">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <xsl:if test="rows/content/table_2/fields/id_servico_check">
                                                                            <th class="bs-checkbox gen-fields-holder" align="center">
                                                                                <input type="checkbox" class="IGRP_checkall" check-rel="id_servico_check" title="Id_servico_check" data-toggle="tooltip"/>
                                                                            </th>
                                                                        </xsl:if>
    ...
    <xsl:include href="../../../xsl/tmpl/IGRP-functions.tmpl.xsl?v=1504826181565"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-variables.tmpl.xsl?v=1504826181565"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=1504826181565"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-utils.tmpl.xsl?v=1504826181565"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-form-utils.tmpl.xsl?v=1504826181565"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-table-utils.tmpl.xsl?v=1504826181565"/>
</xsl:stylesheet>

...
public class AGENDA_PRESENCAView extends View {
	...
	public AGENDA_PRESENCAView(AGENDA_PRESENCA model){
		...
		btn_cancelar = new IGRPButton("Cancelar","agenda","AGENDA_PRESENCA","cancelar","alert_submit","danger|fa-remove","","");
		btn_cancelar.propertie.add("type","specific").add("code","").add("rel","cancelar");
